...
![](http://wx1.sinaimg.cn/mw690/8db6a107gy1fwyc8vm40dj20go09djre.jpg)
...
![](http://wx1.sinaimg.cn/mw690/8db6a107gy1fwyafwix8jj21hc0u0e81.jpg)
...
![](http://wx2.sinaimg.cn/mw690/8db6a107gy1fwyaza2lebj21hc0u0acr.jpg)

在这个简易的图形界面中，我们可以看到有 `4` 个 `tab` 可用`Alt+Tab` 按键进行切换，第一个是 `debug`，其余 `3` 个是普通终端，可在上面输入命令

![](http://wx3.sinaimg.cn/mw690/8db6a107gy1fwyb47dqu3j21hc0u0dh4.jpg)
...
volume
```
 - `blob` 文件夹中其实是一些二进制数据，具体该该文件夹的作用尚不明确
