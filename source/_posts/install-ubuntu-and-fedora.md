...
![VBOX](https://image.locez.com/blog/install-ubuntu-and-fedora-00.png)

点击新建后会出来如下图所示的界面，一般如图填写即可，内存可酌情填写

![NEWUBUNTU](https://image.locez.com/blog/install-ubuntu-and-fedora-01.png)

下一步将创建虚拟硬盘，如图所示，默认位置为 C 盘，如果你不想在 C 盘创建，请确保你选择的盘格式为NTFS

![NEWUBUNTU](https://image.locez.com/blog/install-ubuntu-and-fedora-02.png)

创建完成后，请点 **设置** 如图加载 ISO 文件

![LOADUBUNTUISO](https://image.locez.com/blog/install-ubuntu-and-fedora-03.png)
...
![INSTALLING](https://image.locez.com/blog/install-ubuntu-and-fedora-04.png)

![INSTALLING2](https://image.locez.com/blog/install-ubuntu-and-fedora-05.png)
...
![INSTALLING3](https://image.locez.com/blog/install-ubuntu-and-fedora-06.png)

如图，进行用户设定，**计算机名** 是主机名，**用户名** 是登录时用的账户名称，**密码** 则是你所设 **用户名** 的登录密码，请务必记牢。

![INSTALLING4](https://image.locez.com/blog/install-ubuntu-and-fedora-07.png)

这一步之后会选择时区，直接点下一步即可，键盘选择如下图

![SELECTKEYBOARD](https://image.locez.com/blog/install-ubuntu-and-fedora-08.png)

配置选择已完成，接下来请耐心等待安装过程，如图，请不要点击 **SKIP** 

![INSTALLING](https://image.locez.com/blog/install-ubuntu-and-fedora-09.png)

耐心等待安装完成，然后会重启进入系统，用你上面配置的用户名和密码登录，请注意最好不要登录 **root** ，你可以用 `sudo` 命令来获取相应的权限，下图是展示成果

![FINISH](https://image.locez.com/blog/install-ubuntu-and-fedora-10.png)
...
![STARTLIVECD](https://image.locez.com/blog/install-ubuntu-and-fedora-11.png)

接下来依然是如图操作

![INSTALLING](https://image.locez.com/blog/install-ubuntu-and-fedora-12.png)

然后是选择语言，选择完后进入如图界面

![INSTALLING1](https://image.locez.com/blog/install-ubuntu-and-fedora-13.png)
...
![INSTALLING2](https://image.locez.com/blog/install-ubuntu-and-fedora-14.png)

下一步将创建 **root** 和 **日常使用账户** ，**root** 账户有最大的管理权限，你甚至可以将整个系统删除，所以使用 **root** 账户请务必小心，**日常使用账户** 应作为你的习惯使用账户，必要时只需使用 `sudo` 命令暂时提升权限即可，更多说明如图所示

![INSTALLING3](https://image.locez.com/blog/install-ubuntu-and-fedora-15.png)

**root**  配置只需创建密码即可，下图是 **日常使用账户** 配置

![INSTALLING4](https://image.locez.com/blog/install-ubuntu-and-fedora-16.png)

配置完后将回到之前的界面，请耐心等待安装，如图

![INSTALLING5](https://image.locez.com/blog/install-ubuntu-and-fedora-17.png)

安装完成，点击 **退出** 后，进入的依然是 Live CD 环境，请先关机，再执行下一步

![INSTALLING6](https://image.locez.com/blog/install-ubuntu-and-fedora-18.png)

由于 Fedora 未自动卸载盘片，因此需要手动卸载盘片，否则将再次进入 Live CD 环境，请如图操作

![INSTALLING7](https://image.locez.com/blog/install-ubuntu-and-fedora-19.png)

接下来则是点击 **启动** 进入你的 Fedora ，使用你上面设置的用户名和密码登录，请注意最好不要登录 **root** ，你可以用 `sudo` 命令来获取相应的权限，下图是展示成果

![INSTALLING8](https://image.locez.com/blog/install-ubuntu-and-fedora-20.png)
