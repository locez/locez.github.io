...
![](https://image.locez.com/blog/install-program-on-ubuntu-fedora-00.jpg)
...
![softwarecenter](https://image.locez.com/blog/install-program-on-ubuntu-fedora-01.png)

点击已安装可以查看安装在本机的软件包，并且可以在此管理它们，如图选中 Firefox 并点击卸载，此时会提示你输入密码，输入完成且正确就会卸载你所选的程序。

![installed](https://image.locez.com/blog/install-program-on-ubuntu-fedora-02.png)
接下来在搜索框搜索 `wget` 你可以看到如图所示的东西，并且只需点击安装并正确输入密码即可。

![installnewprogram](https://image.locez.com/blog/install-program-on-ubuntu-fedora-03.png)
...
![softwarecentericon](https://image.locez.com/blog/install-program-on-ubuntu-fedora-04.png)

打开后界面如图，分类在最下面

![softwarecenter](https://image.locez.com/blog/install-program-on-ubuntu-fedora-05.png)

点开上图的扫雷，显示如下，点击 **安装** ，静候即可

![installnewprogram](https://image.locez.com/blog/install-program-on-ubuntu-fedora-06.png)

现在转到 **已安装** ，我们可以看到刚刚安装的扫雷，点击 **移除** ，就可以删除了。

![removenewprogram](https://image.locez.com/blog/install-program-on-ubuntu-fedora-07.png)

如果你遇到下图，只需要输入你的密码即可。

![authoritarian](https://image.locez.com/blog/install-program-on-ubuntu-fedora-08.png)
